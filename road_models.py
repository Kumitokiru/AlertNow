...
arima_model = None
try:
    arima_model = joblib.load(os.path.join(os.path.dirname(__file__), 'training', 'Road Models', 'arima_70_15_15.pkl'))
    logger.info("arima_70_15_15.pkl loaded successfully.")
except FileNotFoundError:
    logger.error("arima_70_15_15.pkl not found.")
except Exception as e:
    logger.error(f"Error loading arima_70_15_15.pkl: {e}")
